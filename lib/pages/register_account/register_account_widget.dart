...
import '/components/message_send_email_verification/message_send_email_verification_widget.dart';
                        ...
                        child: Row(
                          ...
                          children: [
                            if (Theme.of(context).brightness == Brightness.dark)
                              Image.asset(
                                'assets/images/DEE-Logo-White.png',
                                width: 275.0,
                                height: 275.0,
                                fit: BoxFit.fitWidth,
                              ),
                            if (!(Theme.of(context).brightness ==
                                Brightness.dark))
                              Image.asset(
                                'assets/images/DEE-Logo-Black.png',
                                width: 275.0,
                                height: 275.0,
                                fit: BoxFit.fitWidth,
                              ),
                                    ...
                                    await showModalBottomSheet(
                                      ...
                                      builder: (context) {
                                        return Padding(
                                          ...
                                          child:
                                              MessageSendEmailVerificationWidget(),
                                        );
                                      },
                                    ).then((value) => setState(() {}));
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            context.goNamedAuth('userProfile', context.mounted);
                          },
